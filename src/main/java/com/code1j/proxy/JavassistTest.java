...
public class JavassistTest {
    ...
    public void test() throws Exception {
        ...
        CtClass ctClass = pool.get("com.code1j.proxy.Test");

        CtClass returnType = pool.get("java.lang.String");

        CtClass[] c = new CtClass[1];c[0] =returnType;

        CtMethod ctMethod1 = new CtMethod(returnType,"ttt",c,returnType);

        ctClass.addMethod(ctMethod1);

        CtMethod ctMethod = ctClass.getDeclaredMethod("sout");
